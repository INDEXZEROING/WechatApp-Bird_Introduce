...
backgroundAudioManager.src = 'https://i.y.qq.com/v8/playsong.html?songid=249109988&source=yqq#wechat_redirect' // 设置了 src 之后会自动播放 
...
Page({
  data: {
    animationData: {},
    cardInfoList: [{
      cardUrl: '/images/aboutme/about4.jpg',
      cardInfo: {
        cardTitle: '黑暗总会过去',
        cardInfoMes: ['没有压力的生活就会空虚；', '没有压力的青春就会枯萎；', '没有压力的生命就会黯淡。']
      }
    }, {
      cardUrl: '/images/aboutme/about2.jpg',
      cardInfo: {
        cardTitle: '黎明终会到来。',
        cardInfoMes: ['立足今日', '展望明天', '每天都是一个新的起点']
      }
    }, {
      cardUrl: '/images/aboutme/about1.jpg',
      cardInfo: {
        cardTitle: '你从不孤单',
